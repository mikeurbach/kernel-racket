...
module attributes {tf.versions = {bad_consumers = [], min_consumer = 12 : i32, producer = 175 : i32}, tf_saved_model.semantics} {
  func @__inference_gcd_380(%arg0: tensor<i32> {tf_saved_model.index_path = [0]}, %arg1: tensor<i32> {tf_saved_model.index_path = [1]}) -> (tensor<i32> {tf_saved_model.index_path = []}) attributes {tf._XlaMustCompile = true, tf._input_shapes = ["tfshape$", "tfshape$"], tf._noinline = true, tf_saved_model.exported_names = ["gcd"]} {
    ...
    %1 = "xla_hlo.constant"() { value = dense<-1> : tensor<i32> } : () -> tensor<i32>
    %2 = "xla_hlo.tuple"(%0, %1, %arg0, %arg1) : (tensor<i32>, tensor<i32>, tensor<i32>, tensor<i32>) -> tuple<tensor<i32>, tensor<i32>, tensor<i32>, tensor<i32>>
    %3 = "xla_hlo.while"(%2) ( {
    ^bb0(%arg2: tuple<tensor<i32>, tensor<i32>, tensor<i32>, tensor<i32>>):	// no predecessors
      ...
      %12 = call @while_cond_90(%8, %9, %10, %11) : (tensor<i32>, tensor<i32>, tensor<i32>, tensor<i32>) -> tensor<i1>
    ...
    ^bb0(%arg2: tuple<tensor<i32>, tensor<i32>, tensor<i32>, tensor<i32>>):	// no predecessors
      ...
      %10 = "xla_hlo.get_tuple_element"(%arg2) {index = 2 : i32} : (tuple<tensor<i32>, tensor<i32>, tensor<i32>, tensor<i32>>) -> tensor<i32>
      %11 = "xla_hlo.get_tuple_element"(%arg2) {index = 3 : i32} : (tuple<tensor<i32>, tensor<i32>, tensor<i32>, tensor<i32>>) -> tensor<i32>
      %12:4 = call @while_body_100(%8, %9, %10, %11) : (tensor<i32>, tensor<i32>, tensor<i32>, tensor<i32>) -> (tensor<i32>, tensor<i32>, tensor<i32>, tensor<i32>)
  ...
  func @while_body_100(%arg0: tensor<i32>, %arg1: tensor<i32>, %arg2: tensor<i32>, %arg3: tensor<i32>) -> (tensor<i32>, tensor<i32>, tensor<i32>, tensor<i32>) attributes {tf._input_shapes = ["tfshape$", "tfshape$", "tfshape$", "tfshape$"], sym_visibility = "private"} {
    %0 = "xla_hlo.constant"() { value = dense<1> : tensor<i32> } : () -> tensor<i32>
    %1 = "xla_hlo.remainder"(%arg2, %arg3) : (tensor<i32>, tensor<i32>) -> tensor<i32>
    %2 = "xla_hlo.constant"() { value = dense<0> : tensor<i32> } : () -> tensor<i32>
    %3 = "xla_hlo.compare"(%1, %2) {comparison_direction = "NE"} : (tensor<i32>, tensor<i32>) -> tensor<i1>
    %4 = "xla_hlo.constant"() { value =  dense<0> : tensor<i32> } : () -> tensor<i32>
    ...
    %8 = "xla_hlo.and"(%3, %7) : (tensor<i1>, tensor<i1>) -> tensor<i1>
    %9 = "xla_hlo.add"(%arg3, %1) : (tensor<i32>, tensor<i32>) -> tensor<i32>
    %10 = "xla_hlo.select"(%8, %9, %1) : (tensor<i1>, tensor<i32>, tensor<i32>) -> tensor<i32>
    %11 = "xla_hlo.add"(%arg0, %0) : (tensor<i32>, tensor<i32>) -> tensor<i32>
    return %11, %arg1, %arg3, %10 : tensor<i32>, tensor<i32>, tensor<i32>, tensor<i32>
  }
   func @while_cond_90(%arg0: tensor<i32>, %arg1: tensor<i32>, %arg2: tensor<i32>, %arg3: tensor<i32>) -> tensor<i1> attributes {tf._input_shapes = ["tfshape$", "tfshape$", "tfshape$", "tfshape$"], sym_visibility = "private"} {
    %0 = "xla_hlo.constant"() { value = dense<0> : tensor<i32> } : () -> tensor<i32>
