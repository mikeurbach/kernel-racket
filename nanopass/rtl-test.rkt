     ...
     ((new
      ...
      (bind
       ((in env_in (8 . 0))
        ...
        (in value_in (8 . 0)))
       ((alloc_tuple
         ((invoke (mod pair_instance) (op cons) (in symbol) (in value_in) (reg tuple_ref)))
         load_car)
        (load_car
      ...
      (lookup
       ...
       ((store_ref
        ...
        (load_list_cdr
         ...
         list_ref_check)
        (load_tuple_cdr
         ((invoke (mod pair_instance) (op cdr) (reg tuple_ref) (out value_out)))
         init)
        (load_ref_cdr
